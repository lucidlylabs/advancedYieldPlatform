...
const CodeVerificationPopup: React.FC<CodeVerificationPopupProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative flex flex-col md:flex-row bg-[#080B17] rounded-lg overflow-hidden max-w-[800px] w-full text-white border border-[rgba(255,255,255,0.1)] min-h-[406px] max-h-[90vh]">
                <div className="py-6 md:py-8 px-6 md:px-10 w-full md:w-[450px] flex-shrink-0 flex flex-col justify-between">
                    <div>
                        <h2
                            className="text-[#B88AF8] font-bold mb-3 text-[24px] md:text-[32px] leading-normal tracking-[-0.877px]"
                        >
                            Access Lucidly Private Beta
                        </h2>
                        <p className="text-[#9C9DA2] text-sm font-normal leading-[22px] mb-6">
                            No code? Follow us on X, Telegram, or Discord — invitations are shared
                            with our community.
                        </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mt-6">
                        <button
                            ...
                            className="px-6 py-3 rounded-lg bg-[#B88AF8] text-white text-sm font-semibold leading-[16px] hover:bg-[#A87AE8] transition-colors w-full sm:w-[210px]"
                        >
                            Submit
                        </button>
                        {/* Social Icons group */}
