...
const CustomCard: React.FC<CustomCardProps> = ({
  ...
  return (
    <div
              className={cn(
          "opacity-80",
          "relative overflow-hidden rounded-[4px] bg-[rgba(255,255,255,0.02)] text-card-foreground shadow-sm flex flex-col group transition-all duration-300 ease-out cursor-pointer",
          isStrategyCard
            ? "w-[264px] h-[263px] justify-center items-center gap-[10px]"
            : "w-[264px] h-[311px] max-w-[264px] border border-[rgba(255,255,255,0.05)]",
          className,
          isStrategyCard &&
