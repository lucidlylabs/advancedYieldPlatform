            ...
            {shouldShowBanner && (
                ...
                >
                    <div className="flex flex-col sm:flex-row items-center justify-center text-center text-sm gap-2 w-full">
                        <span className="text-[rgba(215,227,239,0.6)] text-[12px] font-normal leading-[14px] tracking-[0.33px] flex items-center gap-2">
                            <img
                        ...
                        <span>
                            <button
                                ...
                                className="text-[#B88AF8] text-[12px] font-normal leading-[14px] flex items-center gap-1 hover:opacity-80 transition-opacity"
                            >
                                Deposit Now
                                <svg
