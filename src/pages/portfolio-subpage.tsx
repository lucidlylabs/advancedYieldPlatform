                        ...
                        {isRefreshingBalance ? (
                            ...
                            strategiesWithBalance.map((strategy, index) => (
                                <div
                                    ...
                                    className={`grid grid-cols-12 items-center py-4 pl-4 pr-6 relative ${index % 2 === 0
                                        ? "bg-transparent"
                                ...
                                >
                                    <div
                                        className={`absolute left-0 top-0 h-full w-[15%] bg-gradient-to-r from-[rgba(0,209,160,0.15)] to-[rgba(153,153,153,0)] opacity-0 group-hover:opacity-100 ${selectedStrategy?.contract === strategy.contract
                                            ? "opacity-100"
                                            : ""
                                            }`}
                                    ></div>
                                    <div
                                        className={`absolute right-0 top-0 h-full w-[15%] bg-gradient-to-l from-[rgba(0,209,160,0.15)] to-[rgba(153,153,153,0)] opacity-0 group-hover:opacity-100 ${selectedStrategy?.contract === strategy.contract
                                            ? "opacity-100"
                                            : ""
                                            }`}
                                    ></div>
                                    ...
                                    <div className="flex items-center gap-4 col-span-4">
                                        <Image
                                            src={`/images/icons/${strategy.asset.toLowerCase()}-${strategy.type === "stable" ? "stable" : "incentive"
                                                }.svg`}
                                            alt={strategy.asset}
                                            width={32}
                                            height={32}
                                    ...
                                    <div className="flex flex-col items-end col-span-3">
                                        ...
                                        <div
                                            className={`${parseFloat(strategy.apy?.replace("%", "") || "0") >= 0
                                                ? "text-[#00D1A0]"
                                                : "text-[#EF4444]"
                            ...
                            <div className="rounded-[4px] bg-[rgba(255,255,255,0.02)] p-6">
                                ...
                                <div className="flex items-center justify-between p-4  bg-[rgba(255,255,255,0.02)] mb-6 border-b border-[rgba(255,255,255,0.15)]">
                                    <div className="flex items-center gap-4">
                                        <Image
                                            src={`/images/icons/${selectedStrategy.asset.toLowerCase()}-${selectedStrategy.type === "stable"
                                                ? "stable"
                                                : "incentive"
                                                }.svg`}
                                ...
                                <button
                                    className={`w-full py-4 rounded-[4px] border border-[rgba(255,255,255,0.30)] flex justify-center items-center gap-[10px] text-center text-[16px] font-semibold ${isWithdrawing
