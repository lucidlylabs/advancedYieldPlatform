...
const STRATEGY_INFO: StrategyData = {
  stable: {
    USD: {
      description: "Stable USD strategy focuses on maintaining consistent returns through low-risk lending protocols.",
      apy: {
        value: "4.12%",
    ...
    ETH: {
      description: "Stable ETH strategy provides steady returns through diversified staking and lending.",
      apy: {
        value: "5.23%",
    ...
    BTC: {
      description: "Stable BTC strategy generates yield through secure wrapped Bitcoin lending.",
      apy: {
        value: "3.85%",
  ...
  incentives: {
    USD: {
      description: "Incentivized USD strategy maximizes returns through protocol rewards and yield farming.",
      apy: {
        value: "8.45%",
    ...
    ETH: {
      description: "Incentivized ETH strategy combines staking rewards with protocol incentives.",
      apy: {
        value: "9.67%",
    ...
    BTC: {
      description: "Incentivized BTC strategy leverages DeFi protocols with additional reward mechanisms.",
      apy: {
        value: "7.92%",
